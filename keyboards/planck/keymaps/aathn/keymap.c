 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Shift| Ctrl | Alt  | GUI  |Lower |    Space    |Raise | Mouse| Alt  | Ctrl | Shift|
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
  ...
  KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   MOUSE, KC_RALT, KC_RCTL, KC_RSFT
),
...
[_RAISE] = LAYOUT_planck_grid(
  ...
  KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5, _______,   _______, _______, _______, _______, _______,
  MUSIC, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11, _______,  _______, _______, _______, _______, _______,
...
[_LOWER] = LAYOUT_planck_grid(
  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_QUOT,
  _______, _______, _______, _______, _______, _______,   KC_F6, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
  _______, _______, _______, _______, _______, _______,  KC_F12, KC_DOWN, KC_UP, KC_LEFT,   KC_RGHT, _______,
