...
float music_button_song[][2] = STARTUP_SONG;
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Lower|   -  |  =   | Left |Right | Enter| Space| Down | Up   |  [   |   ]  | Raise|
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_preonic_grid(
  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC,
  KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSLS,
  MT(MOD_LGUI, KC_ESC),  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, MT(MOD_LGUI, KC_QUOT),
  KC_LSFT, MT(MOD_LCTL, KC_Z), MT(MOD_LALT, KC_X),    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, MT(MOD_LALT, KC_DOT), MT(MOD_RCTL, KC_SLSH), KC_RSFT,
  LOWER, KC_MINS, KC_EQL, KC_LEFT, KC_RGHT,   KC_ENT,  KC_SPC,  KC_DOWN, KC_UP,   KC_LBRC, KC_RBRC, RAISE
),
 ...
 * | Music|      |      |MsBtn2|MsBtn1|      |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Play | Prev | Next | Home | End  |             |      |      |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_RAISE] = LAYOUT_preonic_grid(
  _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   _______, _______, _______, _______, _______, _______,
  _______, _______, _______, KC_MS_UP, _______,  KC_F11, _______, _______, _______, _______, _______, _______,
  _______, _______, KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT, _______, _______, _______, _______, _______, _______, _______,
  MUSIC,   _______, _______, KC_MS_BTN2, KC_MS_BTN1, _______, _______, _______, _______, _______, _______, _______,
  KC_MPLY, KC_MPRV, KC_MNXT, KC_HOME,  KC_END, _______, _______, _______, _______, _______, _______, _______
),
